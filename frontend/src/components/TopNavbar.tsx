          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
              ...
              <div className="ml-3 relative">
                <div>
                  <button className="bg-white dark:bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
